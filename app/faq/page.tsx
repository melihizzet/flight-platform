    ...
    <main className="min-h-screen overflow-x-hidden bg-white text-slate-900">
      ...
      <section className="bg-slate-50 py-10">
        ...
        <div className="mx-auto max-w-4xl px-5 text-center">
          ...
          <div className="mx-auto flex h-10 w-10 items-center justify-center rounded-xl bg-blue-100 text-lg">
            💬
          </div>
          ...
          <a
            href="/contact"
            className="mt-5 inline-block rounded-lg bg-[#020817] px-5 py-2.5 text-xs font-semibold text-white transition hover:bg-blue-600"
          >
            Bize Ulaşın →
          </a>
