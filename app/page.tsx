  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#020817] text-white overflow-hidden">
        ...
        <header className="border-b border-white/10 backdrop-blur-xl sticky top-0 z-50 bg-[#020817]/80">
        ...
        <section className="max-w-7xl mx-auto px-6 pb-24">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            {[
              ...
              <div
                key={index}
                className="bg-white/5 border border-white/10 overflow-hidden rounded-[28px]"
              >
                <div
        ...
        <footer className="border-t border-white/10 py-16">
          ...
          <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <div className="flex flex-col gap-3 text-white/50">
                <a href="mailto:support@ucgit.com">
                  support@ucgit.com
                </a>

                <a href="mailto:info@ucgit.com">
                  info@ucgit.com
                </a>
              </div>
            </div>
