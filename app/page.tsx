  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#020817] text-white overflow-x-hidden">
        ...
        {/* HEADER */}
        <header className="border-b border-white/10 sticky top-0 z-50 bg-[#020817]/90 backdrop-blur-xl">
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 pt-24 pb-20 relative z-10">
            ...
            <div className="mt-16 max-w-6xl mx-auto">
              ...
              <div className="bg-white/10 border border-white/10 rounded-[32px] p-6 backdrop-blur-xl overflow-hidden">
        ...
        <section className="max-w-7xl mx-auto px-6 py-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            ...
            {[
              ...
              <div
                key={item}
                className="bg-white/5 border border-white/10 rounded-3xl h-32 flex items-center justify-center text-2xl font-bold hover:border-blue-500/50 transition"
              >
                {item}
              </div>
            ))}
